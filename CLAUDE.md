...
**原則**：所有字體顏色都必須考慮背景顏色，保持良好對比度，讓使用者可以輕鬆舒適閱讀。

| 背景類型 | 字體顏色 | 範例 |
|---------|---------|------|
| 深色背景 (如 #1e2440) | 淺色字體 | `rgba(235, 240, 250, 0.9)` 或 `#ebf0fa` |
| 淺色背景 (如 #f5f7fa, #ffffff) | 深色字體 | `#2c3e50` 或 `#1e293b` |
...
| 區域 | 背景色 | 字體色 |
|------|--------|--------|
| 側邊欄/導航 | `#1e2440` (深藍) | `rgba(235, 240, 250, 0.9)` |
| 內容區域 | `#f5f7fa` (淺灰) | `#2c3e50` (深灰) |
| 表單容器 | `#ffffff` (白) | `#2c3e50` |
| 標題 | - | `#1e293b` (深藍灰) |
| 連結 | - | `#3b82f6` (藍) |
| 連結 hover | - | `#1d4ed8` (深藍) |
...
MySite1.Master 已設定：
- 側邊欄 (.sidebar)：深色背景 + 淺色字體
- 內容區域 (.content-area)：淺色背景 + 深色字體
