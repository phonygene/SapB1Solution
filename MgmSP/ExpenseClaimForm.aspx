                    ...
                    <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-half">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control">
                                            <asp:DropDownList ID="ddlDocCurrency" runat="server" AutoPostBack="True"
                                                OnSelectedIndexChanged="ddlDocCurrency_SelectedIndexChanged" Width="40%"
                                                style="margin-right:5px;"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control">
                                            <asp:DropDownList ID="ddlDeliveryAddr" runat="server" AutoPostBack="true"
                            ...
                            <div id="divContentExpense" class="tab-content active" runat="server" ClientIDMode="Static">
                                <div style="margin-bottom: 10px; display:flex; justify-content:space-between;">
                                    ...
                                    <div style="display:flex; align-items:center;">
                                        ...
                                        <asp:Button ID="btnUpload" runat="server" Text="上傳附件" OnClick="btnUpload_Click"
                                        ...
                                        <Columns>
                                            ...
                                            <%-- 幣別與匯率欄位已隱藏，寫入時使用單頭的幣別與匯率 --%>
                                                ...
                                                <asp:TemplateField HeaderText="稅別">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlVatGroup" runat="server" Width="80px"
                                                            AutoPostBack="true"
                                                ...
                                                <asp:TemplateField HeaderText="稅額">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtVatSum" runat="server" Text="0" Width="70px"
                                                            style="text-align:right;" AutoPostBack="true"
                                                ...
                                                <asp:TemplateField HeaderText="含稅金額">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtPriceAfterVat" runat="server" Width="90px"
                                                            style="text-align:right;" AutoPostBack="true"
                                                ...
                                                <asp:TemplateField HeaderText="統一編號">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSTCEG" runat="server"
                                                            Text='<%# Bind("U_STCEG") %>' Width="90px"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="100px" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="憑證號碼">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtXBLNR" runat="server"
                                                            ...
                                                            AutoPostBack="true" OnTextChanged="txtXBLNR_TextChanged">
                                                        </asp:TextBox>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="憑證類型">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlZFORM_CODE" runat="server"
                                                            SelectedValue='<%# Bind("U_ZFORM_CODE") %>' Width="150px">
                        ...
                        <asp:Panel ID="pnlVendorSearch" runat="server" CssClass="modalPopup" style="display:none;">
                            <div class="modalHeader">
                                <span>供應商搜尋</span>
                                <asp:LinkButton ID="btnCloseVendor" runat="server" ForeColor="White" Font-Bold="true"
                                    style="text-decoration:none;">X</asp:LinkButton>
                            </div>
                            <div class="modalBody">
                                <div style="margin-bottom:10px;">
                                    <div style="display:flex; align-items:center;">
                                        <asp:TextBox ID="txtVendorSearchKeyword" runat="server" placeholder="輸入關鍵字...">
                                        </asp:TextBox>
