        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-half">
                            <div class="form-group">
                                <label class="form-label"><span class="required">*</span>請購人工號:</label>
                                <div class="form-control">
                                    <div class="search-combo">
                                        <asp:TextBox ID="txtReqCode" runat="server" placeholder="請點選搜尋"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <label class="form-label">請購人姓名:</label>
                                <div class="form-control">
                                    <div class="search-combo">
                                        <asp:TextBox ID="txtReqName" runat="server" placeholder="請點選搜尋"></asp:TextBox>
                        ...
                        <div class="col-half">
                            ...
                            <div class="form-group">
                                <label class="form-label">SAP 請購單號:</label>
                                <div class="form-control">
                                    <asp:TextBox ID="txtSapDocNum" runat="server" ReadOnly="true"
                                        CssClass="readonly-field" placeholder="核准後自動產生"></asp:TextBox>
                    ...
                    <div class="modalBody">
                        <div style="margin-bottom:10px;">
                            <div style="display:flex; align-items:center;">
                                <asp:TextBox ID="txtReqNameSearchKeyword" runat="server"
                                    placeholder="輸入工號或姓名..."></asp:TextBox>
                                <asp:Button ID="btnDoSearchReqName" runat="server" Text="搜尋"
                        ...
                        <asp:GridView ID="gvReqNameSearch" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Code" HeaderText="工號" />
                ...
                <asp:Panel ID="pnlPdfMerge" runat="server" CssClass="modalPopup" Style="display:none; width:500px;">
                    ...
                    <div class="modalBody" style="padding:20px;">
                        <p style="margin-bottom:15px;">附件中有其它 PDF 檔案，是否要接續到匯出單據上？</p>
                        <p style="color:#666; font-size:12px; margin-bottom:15px;">
                            請在輸入框中輸入數字決定順序（數字越小越前面，不輸入則不合併）：
                        </p>
                    ...
                    <div class="modalFooter">
                        <asp:Button ID="btnPdfMergeCancel" runat="server" Text="取消"
                            CssClass="btn btn-secondary" OnClick="btnPdfMergeCancel_Click" />
                        <asp:Button ID="btnPdfMergeConfirm" runat="server" Text="匯出 PDF"
